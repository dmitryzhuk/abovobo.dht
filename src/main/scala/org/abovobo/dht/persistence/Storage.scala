...
/**
 * Actual implementation of [[org.abovobo.dht.persistence.AbstractStorage]] which uses H2.
 *
 * @param uri     JDBC connection string.
 */
class Storage(uri: String) extends AbstractStorage("org.h2.Driver", uri) with Reader with Writer {
